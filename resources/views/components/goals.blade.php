    ...
    <div class="w-full lg:mt-0 mt-14">
        <div class="flex justify-start w-full lg:mt-0 mt-14">
            <div class="flex flex-col lg:w-4/12">
                ...
                <svg class="mt-10 lg:w-8/12 w-full" viewBox="0 0 934 28" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <div class="lg:w-7/12 w-full">
                <div class="flex flex-col space-y-6">
                    <div class="flex items-center">
                        ...
                        <div class="w-10/12">
                            <h1 class="text-gray-700 lg:text-xl text-lg">                        بث روح الحماس والمثابرة بين الطلاب من خلال الاستخدام الصحيح للتكنولوجيا.
                            </h1>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="w-10/12">
                            <h1 class="text-gray-700 lg:text-xl text-lg">إبراز الجوانب الإبداعية لدى طلبة المدارس في العراق ، من خلال الإعداد والتنظيم لمثل هذه المسابقات.</h1>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="w-10/12">
                            <h1 class="text-gray-700 lg:text-xl text-lg">استثمار أوقات الطلبة من خلال إثراء مواهبهم وميولهم.</h1>
                        </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="w-10/12">
                            <h1 class="text-gray-700 lg:text-xl text-lg">دعم مواهب الطلبة وتشجيعهم على المزيد من الإبداع، وتعزيز الأفكار والخطط الابتكارية المتميزة.</h1>
                        </div>
