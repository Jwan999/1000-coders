...
vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_1___default().use((vue_scrollactive__WEBPACK_IMPORTED_MODULE_0___default()));
window.Vue = (vue_dist_vue_js__WEBPACK_IMPORTED_MODULE_1___default());
