<div id="contact"
    ...
    <div class="lg:w-5/12 w-full lg:mt-0 mt-14">
        ...
        <div class="">
            ...
            <svg class="mt-10 lg:w-7/12 w-full" viewBox="0 0 934 28" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <form method="POST" action="/emails">
            ...
            <div class="flex flex-col mt-10">
                ...
                <input name="name" type="text"
                       class="bg-gray-200 border-2 border-gray-300 focus:border-blue-400 focus:bg-gray-100 text-lg py-3 px-4 rounded-xl outline-none"
                       placeholder="@lang("language.form_name")">
                <input name="email" type="email"
                       class="mt-6 bg-gray-200 border-2 border-gray-300 focus:border-blue-400 focus:bg-gray-100 text-lg py-3 px-4 rounded-xl outline-none"
    ...
    <div class="lg:w-5/12 w-full">
        ...
        <div class="flex lg:flex-col flex-row justify-center lg:justify-start mt-10">
            ...
            <div class="flex items-center cursor-pointer lg:mt-6 mt-0">
