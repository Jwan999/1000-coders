...
<div class="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-10 w-full">
    <div class="flex flex-col w-full mt-6">
        ...
        <p class="text-gray-700 lg:text-xl text-lg items-center mt-4">
            @lang('language.condition_age_body')
    ...
    <div class="flex flex-col w-full mt-6">
        ...
        <p class="text-gray-700 lg:text-xl text-lg items-center mt-4">
            @lang('language.condition_pc_body')
        </p>
    </div>
    <div class="flex flex-col w-full mt-6">
        <div class="flex w-full">
        ...
        <p class="text-gray-700 lg:text-xl text-lg items-center mt-4">
            @lang('language.condition_nation_body')
        </p>
    </div>
    <div class="flex flex-col w-full mt-6">
        <div class="flex w-full">
        ...
        <p class="text-gray-700 lg:text-xl text-lg items-center mt-4">
            @lang('language.condition_interest_body')
        </p>
    </div>
    <div class="flex flex-col w-full mt-6">
        <div class="flex w-full">
        ...
        <p class="text-gray-700 lg:text-xl text-lg items-center mt-4">
            @lang('language.condition_lang_body')
